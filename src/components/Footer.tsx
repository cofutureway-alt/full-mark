    ...
    <footer className="py-12 border-t border-border bg-card relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-3">
            <div className="flex items-center">
              <img src={logoUrl} alt="منصة مستر محمد إبراهيم" className="h-14 w-14 rounded-lg object-contain" />
            </div>
            <p className="text-sm text-muted-foreground">منصة تعليمية متكاملة لتدريس الكيمياء — Full Mark in Chemistry</p>
          </div>
          <div className="space-y-3">
        ...
        <div className="mt-10 pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-muted-foreground">
          <p>جميع الحقوق محفوظة لمنصة مستر محمد إبراهيم {new Date().getFullYear()} ©</p>
          <a
